    ...
    if (!root->children.empty()) {
        ...
        switch (opRoot->toString()[0]) {
            ...
            case '/': {
                ...
                Operator *multOp1 = operators.find("*")->second.setOperands(
                        {derive(operators, wrt, opRoot->children[0]), opRoot->children[1]});

                Operator *multOp2 = operators.find("*")->second.setOperands(
                        {opRoot->children[0], derive(operators, wrt, opRoot->children[1])});
